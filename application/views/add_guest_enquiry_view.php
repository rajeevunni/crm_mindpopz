				...
				<div class="">
                    ...
                    cellspacing="0" width="100%">
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr data-toggle="modal"  data-target=".edit_enquires_popup" id="<?php echo $details['id']; ?>"
                                ...
                                <td>
                                    ...
                                    <a href="#"> <span  class="glyphicon glyphicon-trash action_icon delete_accommodation"></span></a>
                                </td>              
                            </tr>
                            <?php
                                // $i++;

<div class="modal-header">
    ...
    <h4 class="modal-title" id="myModalLabel">Bulk Accommodation Upload</h4>
</div>
<form class="form-horizontal form-label-left" method="post" id="bulkupload_emp" name="bulkupload_emp"
      action="<?php echo base_url() . 'index.php/Vendor/vendor_bulkupload' ?>" enctype="multipart/form-data">

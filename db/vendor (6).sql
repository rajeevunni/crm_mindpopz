...
CREATE TABLE IF NOT EXISTS `accommodation_bulkupload_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `vendor_id` int(11) NOT NULL,
  `start_date` varchar(255) NOT NULL,
  `end_date` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `guest_bulkupload_temp` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
(5, 'Mohit', 'braveman.1988@gmail.com', '', 'Bangalore', '9986659357', '', '', '', '', '', '', '100007', '2000000007', '42535', 'HIQ', 'D1861765', 'Booked', '', '', '', '', 'Paul', '', 'int in pack, cl 15 june 11am to discuss'),
(6, 'Anand Srivastava', 'anant.virgo@gmail.com', '', 'Gurgoan', '9811401508', '', '', '', '', '', '', '100008', '2000000008', '42535', 'HIQ', 'D1861780', 'Cancelled', '', '', '', '', 'Paul', '', 'ok with pack, flight ticket issues, will sort it & cl me, cl 17 June, going to north');
